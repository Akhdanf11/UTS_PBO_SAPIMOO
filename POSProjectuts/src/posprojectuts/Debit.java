 ...
 * @author M IQBAL
 */
public class Debit implements PembayaranInterface{
    ...
    public Debit(String nama_bank, String no_kartu){
    ...
    public void setIDPembayaran(int IDPembayaran) {
     ...
     public void simpanDatabase() throws SQLException{
         try{
            ...
            String sql = "INSERT INTO pembayaran(id_pembayaran, total_harga, waktu_pembayaran,jenis_pembayaran) VALUES(?, ?, ?, ?)";
